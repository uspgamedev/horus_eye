...
class VirtualType(_object):
    ...
    __repr__ = _swig_repr
    def __init__(self): 
        this = _ugdk_audio.new_VirtualType()
        try: self.this.append(this)
        except: self.this = this
    __swig_destroy__ = _ugdk_audio.delete_VirtualType
    __del__ = lambda self : None;
    def FromLang(self, *args): return _ugdk_audio.VirtualType_FromLang(self, *args)
    def RegisterFromLang(self, *args): return _ugdk_audio.VirtualType_RegisterFromLang(self, *args)
VirtualType_swigregister = _ugdk_audio.VirtualType_swigregister
