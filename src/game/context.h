...
void GetCollidingObjects(const std::string& classname, pyramidworks::geometry::GeometricShape* shape, const ugdk::math::Vector2D& pos, std::vector<sprite::WorldObject*> &objects_colliding);
