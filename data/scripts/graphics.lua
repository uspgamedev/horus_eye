...
function graphics.urn()
  local graphic = component.Graphic_Create("scenery", "resources/animations/urn.json")
...
function graphics.switch()
  local graphic = component.Graphic_Create("switch", "resources/animations/switch.json")
  graphic:set_render_offset(-ugdk_math.Vector2D(53, 93))
...
function graphics.spike_trap()
  local graphic = component.Graphic_Create("scenery", "resources/animations/spike-trap.json")
  graphic:set_render_offset(-ugdk_math.Vector2D(53, 135))
  return graphic
end

function graphics.dummy_spike_trap()
  local graphic = component.Graphic_Create("scenery")
  graphic:ChangeToFrame "dummy-spike-trap"
  graphic:set_render_offset(-ugdk_math.Vector2D(53, 135))
  return graphic
end

function graphics.closed_door()
  local graphic = component.Graphic_Create("scenery", "resources/animations/closed-door.json")
