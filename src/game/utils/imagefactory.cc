...
FlexibleSpritesheet* ImageFactory::MagicMissileImage() {
    FlexibleSpritesheet *magicmissile_image_ = VIDEO_MANAGER()->LoadSpritesheet("data/images/blue_fire_ball.png");
...
FlexibleSpritesheet* ImageFactory::FireballImage() {
    FlexibleSpritesheet *fireball_image_ = VIDEO_MANAGER()->LoadSpritesheet("data/images/fireball_0.png");
...
FlexibleSpritesheet* ImageFactory::MummyProjectileImage() {
    FlexibleSpritesheet *mummy_projectile_image_ = VIDEO_MANAGER()->LoadSpritesheet("data/images/green_fire_ball.png");
...
FlexibleSpritesheet* ImageFactory::ExplosionImage() {
    FlexibleSpritesheet *explosion_image_ = VIDEO_MANAGER()->LoadSpritesheet("data/images/explosion.png");
...
FlexibleSpritesheet* ImageFactory::QuakeImage() {
    FlexibleSpritesheet *quake_image_ = VIDEO_MANAGER()->LoadSpritesheet("data/images/quake.png");
    if(quake_image_) quake_image_->set_frame_size( Vector2D(256, 128) );
    return quake_image_;
}

FlexibleSpritesheet* ImageFactory::LifePotionImage() {
    FlexibleSpritesheet *life_potion_image_ = VIDEO_MANAGER()->LoadSpritesheet("data/images/life_potion2.png");
...
FlexibleSpritesheet* ImageFactory::ManaPotionImage() {
    FlexibleSpritesheet *mana_potion_image_ = VIDEO_MANAGER()->LoadSpritesheet("data/images/mana_potion.png");
...
FlexibleSpritesheet* ImageFactory::SightPotionImage() {
    FlexibleSpritesheet *sight_potion_image_ = VIDEO_MANAGER()->LoadSpritesheet("data/images/sight_potion.png");
...
FlexibleSpritesheet* ImageFactory::DoorImage() {
    FlexibleSpritesheet *door_image_ = VIDEO_MANAGER()->LoadSpritesheet("data/images/stairs3.png");
    if(door_image_) door_image_->set_frame_size(Vector2D(153, 109));
    return door_image_;
}

FlexibleSpritesheet* ImageFactory::FloorImage() {
    FlexibleSpritesheet *floor_image_ = VIDEO_MANAGER()->LoadSpritesheet("data/images/ground2_106x54.png");
    if(floor_image_) floor_image_->set_frame_size(Vector2D(106,54));
    return floor_image_;
}

FlexibleSpritesheet* ImageFactory::WallImage() {
    FlexibleSpritesheet *wall_image_ = VIDEO_MANAGER()->LoadSpritesheet("data/images/stoneblock3.png");
    if(wall_image_) wall_image_->set_frame_size(Vector2D(106, 157));
    return wall_image_;
}

FlexibleSpritesheet* ImageFactory::EntryImage() {
    FlexibleSpritesheet *entry_image_ = VIDEO_MANAGER()->LoadSpritesheet("data/images/door.png");
    if(entry_image_) entry_image_->set_frame_size(Vector2D(106, 157));
    return entry_image_;
}

FlexibleSpritesheet* ImageFactory::LightningImage() {
    FlexibleSpritesheet *lightning_image_ = VIDEO_MANAGER()->LoadSpritesheet("data/images/lightning_bolt.png");
...
FlexibleSpritesheet* ImageFactory::LightImage() {
    FlexibleSpritesheet *light_image_ = VIDEO_MANAGER()->LoadSpritesheet("data/images/yellow_fire_ball.png");
    if(light_image_) light_image_->set_frame_size( Vector2D(32, 32) );
    return light_image_;
}

FlexibleSpritesheet* ImageFactory::TileSwitchImage() {
    FlexibleSpritesheet *floor_image_ = VIDEO_MANAGER()->LoadSpritesheet("data/images/tile_switch.png");
    if(floor_image_) floor_image_->set_frame_size(Vector2D(106,54));
    return floor_image_;
}
