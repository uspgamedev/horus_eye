...
WorldObject* ExplosionBuilder::FireballExplosion() {
    ...
    col->AddCollisionLogic("Mummy", new ExplosionCollision(Constants::FIREBALL_EXPLOSION_DAMAGE));
...
WorldObject* ExplosionBuilder::EarthquakeExplosion() {
    ...
    CollisionObject* col = wobj->collision_object();
    col->AddCollisionLogic("Mummy", new ExplosionCollision(Constants::QUAKE_EXPLOSION_DAMAGE));
...
WorldObject* ExplosionBuilder::MeteorExplosion() {
    ...
    CollisionObject* col = wobj->collision_object();
    col->AddCollisionLogic("Mummy", new ExplosionCollision(Constants::METEOR_EXPLOSION_DAMAGE));
